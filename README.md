...
> ⚖️📦➕ **Arquitetura da aplicação**: Essa aplicação possui uma estrutura monolítica atuando com a arquitetura MVC (Model View Controller) e ODM (Object Document Model).
